...
class ChoiceMenu:
    def __init__(self):
        ...
        self.button_play = Button(None, "Play", NORMAL_FONT, (220, 610), None, BLACK, BLACK, None)
        self.button_pokedex = Button(None, "Open Pokedex", NORMAL_FONT, (500, 610), None, BLACK, BLACK, None)
        self.button_reset = Button(None, "Reset game", NORMAL_FONT, (480, 650), None, BLACK, BLACK, None)
        self.button_quit = Button(None, "Quit", NORMAL_FONT, (215, 650), None, BLACK, BLACK, None)
